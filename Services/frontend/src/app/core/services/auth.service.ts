...
export class AuthService {
  ...
  getProfile(): Observable<any> {
    return this.http.get<any>(`${environment.authApiUrl}/auth/me`);
  }

  updateProfile(profileData: { friend_email?: string; friend_phone?: string; domains?: string }): Observable<any> {
    return this.http.put<any>(`${environment.authApiUrl}/auth/profile`, profileData);
  }
